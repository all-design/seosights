...
const SEED_MEMORIES = [
  {
    ...
    feature: 'Regex-based codebase scanning',
    filesChanged: 'src/lib/codebase-scanner.ts',
    ...
    occurrences: 5,
    confidence: 0.92,
    patternLearned: 'Regex-based AST parsing is faster than full AST walk for component counting.',
    outcome: 'success',
  ...
  },
  {
    ...
    feature: 'AI Router circuit breaker fallback',
    filesChanged: 'src/lib/ai-router.ts',
    ...
    occurrences: 12,
    confidence: 0.88,
    patternLearned: 'Circuit breaker with 5-minute cooldown prevents cascade failures.',
    outcome: 'success',
  ...
  },
  {
    ...
    filesChanged: 'src/lib/ai-governor.ts',
    ...
    occurrences: 8,
    confidence: 0.85,
    patternLearned: '6-question decision framework catches 94% of risky actions.',
    outcome: 'success',
  ...
  },
  {
    ...
    feature: 'Budget-constrained mission generation',
    filesChanged: 'src/lib/daily-mission-generator.ts',
    ...
    occurrences: 3,
    confidence: 0.82,
    patternLearned: 'Budget-constrained task selection produces higher-quality missions.',
    outcome: 'success',
  ...
  },
  {
    ...
    filesChanged: 'scripts/turso-schema-push.ts',
    ...
    occurrences: 4,
    confidence: 0.90,
    patternLearned: 'Use @libsql/client directly for DDL on Turso.',
    outcome: 'success',
    testsAdded: 2, testsPassed: 2, testsFailed: 0,
  },
  {
    ...
    feature: 'Vercel Hobby Plan cron batching',
    filesChanged: 'vercel.json',
    ...
    occurrences: 2,
    confidence: 0.95,
    patternLearned: 'Hobby plan allows 1 cron/day. Batched daily schedules.',
    outcome: 'success',
  ...
  },
  {
    ...
    feature: 'QA Engine parallel reviewers',
    filesChanged: 'mini-services/qa-engine/index.ts',
    ...
    occurrences: 6,
    confidence: 0.75,
    patternLearned: '11 reviewers run in parallel for speed.',
    outcome: 'partial',
    testsAdded: 3, testsPassed: 3, testsFailed: 0,
  },
  {
    ...
    feature: 'Factory status recency probes',
    filesChanged: 'src/app/api/factory/status/route.ts',
    ...
    occurrences: 1,
    confidence: 0.90,
    patternLearned: 'Recency-based status is more accurate than count>0.',
    outcome: 'success',
    testsAdded: 1, testsPassed: 1, testsFailed: 0,
  },
]
