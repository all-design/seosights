...
const sidebarItems: { key: GrowthSection; label: string; icon: React.ElementType }[] = [
  { key: 'dashboard', label: 'Dashboard', icon: LayoutDashboard },
  { key: 'discovery', label: 'Discovery', icon: Search },
  { key: 'opportunities', label: 'Opportunities', icon: Target },
  { key: 'queue', label: 'Queue', icon: Columns3 },
...
export function GrowthSidebar({ className }: GrowthSidebarProps) {
  const { section, setSection } = useGrowthStore()
          ...
          return (
            ...
            >
              ...
              <AnimatePresence>
                {isActive && (
                  <motion.div
                    layoutId="growth-sidebar-active"
