...
const TASK_MODEL_MAP: Record<TaskType, string[]> = {
  scoring:           ['openrouter/glm-turbo', 'openrouter/glm-5.2', 'openrouter/glm-5.1', 'groq/llama-3.1-8b', 'groq/llama-3.1-70b', 'gemini/flash', 'openrouter/deepseek-v3', 'openai/gpt-4o-mini', 'ollama/llama3', 'zai/default'],
  entity_extraction: ['openrouter/glm-turbo', 'openrouter/glm-5.2', 'openrouter/glm-5.1', 'groq/llama-3.1-8b', 'groq/llama-3.1-70b', 'gemini/flash', 'openrouter/deepseek-v3', 'openai/gpt-4o-mini', 'ollama/llama3', 'zai/default'],
  summarization:     ['openrouter/glm-turbo', 'openrouter/glm-5.2', 'openrouter/glm-5.1', 'groq/llama-3.1-8b', 'groq/llama-3.1-70b', 'gemini/flash', 'openrouter/deepseek-v3', 'openai/gpt-4o-mini', 'ollama/llama3', 'zai/default'],
  long_report:       ['openrouter/glm-5.2', 'openrouter/glm-turbo', 'openrouter/glm-5.1', 'groq/llama-3.1-70b', 'gemini/pro', 'gemini/flash', 'openrouter/deepseek-v3', 'groq/llama-3.1-8b', 'openai/gpt-4o', 'ollama/llama3', 'zai/default'],
  strategy:          ['openrouter/glm-5.2', 'openrouter/glm-turbo', 'openrouter/glm-5.1', 'groq/llama-3.1-70b', 'openai/gpt-4o', 'gemini/pro', 'openrouter/deepseek-v3', 'groq/llama-3.1-8b', 'ollama/llama3', 'zai/default'],
  code:              ['openrouter/glm-turbo', 'openrouter/glm-5.2', 'openrouter/glm-5.1', 'openrouter/deepseek-v3', 'groq/llama-3.1-70b', 'gemini/flash', 'openai/gpt-4o-mini', 'groq/llama-3.1-8b', 'ollama/llama3', 'zai/default'],
  reasoning:         ['openrouter/glm-5.2', 'openrouter/glm-turbo', 'openrouter/glm-5.1', 'groq/llama-3.1-70b', 'openai/gpt-4o', 'gemini/pro', 'openrouter/deepseek-v3', 'groq/llama-3.1-8b', 'ollama/llama3', 'zai/default'],
  classification:    ['openrouter/glm-turbo', 'openrouter/glm-5.2', 'openrouter/glm-5.1', 'groq/llama-3.1-8b', 'groq/llama-3.1-70b', 'gemini/flash', 'openrouter/deepseek-v3', 'ollama/llama3', 'zai/default'],
  chat:              ['openrouter/glm-turbo', 'openrouter/glm-5.2', 'openrouter/glm-5.1', 'groq/llama-3.1-8b', 'groq/llama-3.1-70b', 'gemini/flash', 'openai/gpt-4o-mini', 'ollama/llama3', 'zai/default'],
  embedding:         ['openrouter/glm-turbo', 'gemini/flash', 'openrouter/glm-5.1', 'groq/llama-3.1-8b', 'ollama/llama3', 'zai/default'],
}
