...
const TASK_MODEL_MAP: Record<TaskType, string[]> = {
  ...
  long_report:       ['gemini/pro', 'gemini/flash', 'groq/llama-3.1-70b', 'openrouter/glm-5.1', 'openrouter/deepseek-v3', 'openai/gpt-4o', 'zai/default', 'ollama/llama3'],
  strategy:          ['openai/gpt-4o', 'groq/llama-3.1-70b', 'openrouter/glm-5.1', 'gemini/pro', 'openrouter/deepseek-v3', 'zai/default', 'ollama/llama3'],
  code:              ['openrouter/deepseek-v3', 'openrouter/glm-5.1', 'groq/llama-3.1-70b', 'gemini/flash', 'openai/gpt-4o-mini', 'zai/default', 'ollama/llama3'],
  reasoning:         ['openai/gpt-4o', 'groq/llama-3.1-70b', 'openrouter/glm-5.1', 'gemini/pro', 'openrouter/deepseek-v3', 'zai/default', 'ollama/llama3'],
